...
data = [
  ...
  [
    ...
    50.07239200
    14.40595600
    'a:7:{i:0;s:12:"9:00 - 18:00";i:1;s:12:"9:00 - 18:00";i:2;s:12:"9:00 - 18:00";i:3;s:12:"9:00 - 18:00";i:4;s:12:"9:00 - 18:00";i:5;s:8:"Zavřeno";i:6;s:8:"Zavřeno";}'
    '775 577 060'
    '257 315 889'
    'prodejna@weleda.cz'
    'Firma je registrována pod spisovou značkou C 3981 ze dne 10.09. 1991 u rejstříkového soudu v Praze.'
    1
    'weleda'
    '2012-03-16 17:22:30'
    '2016-12-20 12:16:55'
...
locations.forEach (element) ->
  markers.push L.marker([
    element.x
    element.y
  ]).addTo(map).bindPopup(element.title)
  return
